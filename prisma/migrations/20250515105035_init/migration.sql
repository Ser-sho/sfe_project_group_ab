...
-- CreateEnum
CREATE TYPE "IssueStatus" AS ENUM ('PENDING', 'IN_PROGRESS', 'FIXED', 'NOT_FIXED');
...
-- AddForeignKey
ALTER TABLE "Issue" ADD CONSTRAINT "Issue_lecturerId_fkey" FOREIGN KEY ("lecturerId") REFERENCES "Lecturer"("id") ON DELETE SET NULL ON UPDATE CASCADE;
